...
:: Option 1 is used by default, if you whant to use Option 2 you need to comment all lines under "Option 1" and uncomment all lines under "Option 2"
:: Remember that Option 2 requires "nvidiaInspector" and MSIAfterburner, you can tune Option 2 to your needs 
...
::echo "Profile 2 set" >> logs\GPU_Lost.txt
::timeout 4
