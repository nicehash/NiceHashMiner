...
copy /y .\build_settings\build_settings_testnet.json .\..\Release\build_settings.json
...
.\nhmpacker\bins_bundle\7z\7z.exe a -tzip %filename%_testnet.zip .\%filename%\*
...
if exist .\%filename%_release_files\%filename%_testnet_release_files (
    echo "Folder already exists, deleting."
    rmdir /s /q .\%filename%_release_files\%filename%_testnet_release_files
)
mkdir .\%filename%_release_files\%filename%_testnet_release_files
copy nhm_windows_*.* .\%filename%_release_files\%filename%_testnet_release_files\
