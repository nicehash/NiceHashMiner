...
namespace NHM.DeviceMonitoring.AMD
{
    internal static class AMD_ODN
    {
        ...
        // non ADL_RET
        [DllImport("device_monitoring_amd.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int nhm_amd_reg_log_cb(log_cb cb);
        [DllImport("device_monitoring_amd.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int nhm_amd_log(string what);
        [DllImport("device_monitoring_amd.dll", CallingConvention = CallingConvention.StdCall)]
