    ...
    public partial class GMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public GMinerPlugin()
        {
            ...
            MinersBinsUrlsSettings = new MinersBinsUrlsSettings
            {
                ...
                {
                    "https://github.com/develsoftware/GMinerRelease/releases/download/2.11/gminer_2_11_windows64.zip", // original
                }
            };
        ...
        public override bool ShouldReBenchmarkAlgorithmOnDevice(BaseDevice device, Version benchmarkedPluginVersion, params AlgorithmType[] ids)
        {
            try
            {
                if (ids.Count() != 0)
                {
                    ...
                    if (benchmarkedPluginVersion < Version) return ids.First() == AlgorithmType.GrinCuckatoo32;
                }
            }
            catch (Exception e)
            {
