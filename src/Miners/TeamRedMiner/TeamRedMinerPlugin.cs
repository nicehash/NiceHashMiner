    ...
    public class TeamRedMinerPlugin : PluginBase
    {
        public TeamRedMinerPlugin()
        {
            ...
            PluginMetaInfo = new PluginMetaInfo
            {
                ...
                {
                    { DeviceType.AMD, new List<AlgorithmType>{ AlgorithmType.CryptoNightR, AlgorithmType.Lyra2REv3, AlgorithmType.Lyra2Z, AlgorithmType.X16R, AlgorithmType.GrinCuckatoo31, AlgorithmType.GrinCuckarood29, AlgorithmType.MTP, AlgorithmType.X16Rv2 } }
                }
            };
        }
