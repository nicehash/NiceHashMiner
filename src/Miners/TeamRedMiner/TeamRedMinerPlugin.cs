...
namespace TeamRedMiner
{
    public partial class TeamRedMinerPlugin : PluginBase
    {
        public TeamRedMinerPlugin()
        {
            ...
            {
                BinVersion = "0.7.21",
                ExePath = new List<string> { "teamredminer-v0.7.21-win", "teamredminer.exe" },
                Urls = new List<string>
                {
                    "https://github.com/todxx/teamredminer/releases/download/0.7.21/teamredminer-v0.7.21-win.zip", // original
                }
            };
