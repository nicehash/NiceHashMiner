...
namespace TeamRedMiner
{
    public partial class TeamRedMinerPlugin : PluginBase
    {
        public TeamRedMinerPlugin()
        {
            ...
            {
                BinVersion = "0.7.9",
                ExePath = new List<string> { "teamredminer-v0.7.9-win", "teamredminer.exe" },
                Urls = new List<string>
                {
                    "https://github.com/todxx/teamredminer/releases/download/0.7.9/teamredminer-v0.7.9-win.zip", // original
                }
            };
        ...
        public override Version Version => new Version(11, 9);
