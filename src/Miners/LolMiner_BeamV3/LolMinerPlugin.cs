...
namespace LolMiner_BeamV3
{
    public partial class LolMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public LolMinerPlugin()
        {
            ...
            {
                BinVersion = "1.0",
                ExePath = new List<string> { "1.0", "lolMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.0/lolMiner_v1.0_Win64.zip" // original
                }
            };
        ...
        public override Version Version => new Version(13, 0);

        public override string Name => "lolMiner-BeamV3";

        public override string Author => "info@nicehash.com";

        public override string PluginUUID => "e9d0cc80-b849-11ea-b902-03a364a6d0e2";
