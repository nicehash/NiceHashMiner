...
namespace NanoMiner
{
    public partial class NanoMinerPlugin : PluginBase, IDevicesCrossReference, IDriverIsMinimumRecommended, IDriverIsMinimumRequired
    {
        public NanoMinerPlugin()
        {
            ...
            {
                BinVersion = "v3.7.7",
                ExePath = new List<string> { "nanominer-windows-3.7.7-cuda11", "nanominer.exe" },
                Urls = new List<string>
                {
                    "https://github.com/nanopool/nanominer/releases/download/v3.7.7/nanominer-windows-3.7.7-cuda11.zip", // original
                }
            };
