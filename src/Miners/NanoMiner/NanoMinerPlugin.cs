...
namespace NanoMiner
{
    public partial class NanoMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public NanoMinerPlugin()
        {
            ...
            {
                BinVersion = "v3.3.11",
                ExePath = new List<string> { "nanominer-windows-3.3.11-cuda11", "nanominer.exe" },
                Urls = new List<string>
                {
                    "https://github.com/nanopool/nanominer/releases/download/v3.3.11/nanominer-windows-3.3.11-cuda11.zip", // original
                }
            };
