...
namespace Phoenix
{
    public partial class PhoenixPlugin : PluginBase, IDevicesCrossReference
    {
        public PhoenixPlugin()
        {
            ...
            {
                BinVersion = "5.2b",
                ExePath = new List<string> { "PhoenixMiner_5.2b_Windows_AMD_NVIDIA", "PhoenixMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/PhoenixMiner-download/PhoenixMiner/releases/download/5.2b/PhoenixMiner_5.2b_Windows_AMD_NVIDIA.zip"
                }
            };
