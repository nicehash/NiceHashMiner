...
namespace Phoenix
{
    public partial class PhoenixPlugin : PluginBase, IDevicesCrossReference
    {
        public PhoenixPlugin()
        {
            ...
            {
                BinVersion = "5.2b",
                ExePath = new List<string> { "PhoenixMiner_5.2b_Windows", "PhoenixMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/nicehash/MinerDownloads/releases/download/3.0.0.2/PhoenixMiner_5.2b_Windows.zip",
                    "https://mega.nz/folder/3NNgWZDL#dF98TZLLbnpVDzx1ZaQxng/file/aQNgEB6Y" // original
                }
            };
