...
namespace LolMiner
{
    public partial class LolMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public LolMinerPlugin()
        {
            ...
            {
                BinVersion = "1.11",
                ExePath = new List<string> { "1.11", "lolMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.11/lolMiner_v1.11_Win64.zip" // original
                }
            };
        ...
        public override Version Version => new Version(13, 11);
