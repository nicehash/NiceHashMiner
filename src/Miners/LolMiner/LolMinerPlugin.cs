...
namespace LolMiner
{
    public partial class LolMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public LolMinerPlugin()
        {
            ...
            {
                BinVersion = "1.12",
                ExePath = new List<string> { "1.12", "lolMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.12/lolMiner_v1.12_Win64.zip" // original
                }
            };
        ...
        public override Version Version => new Version(13, 12);
...
#warning TEMP disable NVIDIA driver check
        ...
        public override bool ShouldReBenchmarkAlgorithmOnDevice(BaseDevice device, Version benchmarkedPluginVersion, params AlgorithmType[] ids)
        {
            ...
            if (ids.First() == AlgorithmType.DaggerHashimoto && benchmarkedPluginVersion.Major == 13 && benchmarkedPluginVersion.Minor < 12) return true;
            return false;
        }
    }
}
