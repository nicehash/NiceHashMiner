...
namespace LolMiner
{
    public partial class LolMinerPlugin : PluginBase, IDevicesCrossReference, IDriverIsMinimumRecommended, IDriverIsMinimumRequired
    {
        public LolMinerPlugin()
        {
            ...
            {
                BinVersion = "1.98a",
                ExePath = new List<string> { "1.98a", "lolMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.98a/lolMiner_v1.98a_Win64.zip" // original
                }
            };
        ...
        public override Version Version => new Version(24, 6);
