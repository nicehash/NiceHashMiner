...
namespace LolMiner
{
    public partial class LolMinerPlugin : PluginBase, IDevicesCrossReference
    {
        public LolMinerPlugin()
        {
            ...
            {
                BinVersion = "1.03",
                ExePath = new List<string> { "1.03", "lolMiner.exe" },
                Urls = new List<string>
                {
                    "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.03/lolMiner_v1.03_Win64.zip" // original
                }
            };
        ...
        public override Version Version => new Version(13, 4);
        ...
        public override bool ShouldReBenchmarkAlgorithmOnDevice(BaseDevice device, Version benchmarkedPluginVersion, params AlgorithmType[] ids)
        {
            ...
            if (ids.First() == AlgorithmType.BeamV3 && benchmarkedPluginVersion.Major == 13 && benchmarkedPluginVersion.Minor < 3) return true;
            return false;
        }
    }
}
