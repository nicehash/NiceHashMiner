    ...
    public partial class XmrStakRxPlugin : PluginBase, IXmrStakRxConfigHandler
    {
        public XmrStakRxPlugin()
        {
            ...
            MinersBinsUrlsSettings = new MinersBinsUrlsSettings
            {
                ...
                {
                    "https://github.com/nicehash/xmr-stak/releases/download/nhm-2.10.7/xmr-stak-rx-win64-1.0.4.7z", // modded
                    //"https://github.com/fireice-uk/xmr-stak/releases/download/1.0.4-rx/xmr-stak-rx-win64-1.0.4.7z", // original
                }
            };
        ...
        {
            return new XmrStakRx(PluginUUID, this);
        }
