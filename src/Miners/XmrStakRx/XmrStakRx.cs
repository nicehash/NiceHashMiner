...
using XmrStakRx.Configs;

namespace XmrStakRx
{
    public class XmrStakRx : MinerBase, IAfterStartMining
    {
        ...
        protected IXmrStakRxConfigHandler _configHandler;
        ...
        public XmrStakRx(string uuid, IXmrStakRxConfigHandler configHandler) : base(uuid)
        {
        ...
        // XmrStakRx doesn't report power usage
        ...
        protected override string MiningCreateCommandLine()
        {
            ...
            var disableDeviceTypes = CommandLineHelpers.DisableDevCmd(_miningDeviceTypes);
            var commandLine = $@"--noTest --config {folder}\config.txt --poolconf {folder}\pools.txt {deviceConfigParams} {disableDeviceTypes}";
            return commandLine;
        }
